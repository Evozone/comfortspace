                ...
                <Box sx={{
                    ...
                    <Box
                        sx={{
                            ...
                            borderRadius: '15px',
                            border: mode === 'light' ? `1px solid ${deepDark}` : `1px solid ${light}`,
                            display: 'grid',
                            placeItems: 'center',
                            height: '450px',
                            padding: '1rem',
                    ...
                    >
                        ...
                        >
                            ...
                            <br />
                            Please note that
                            this chart is not a substitute for professional medical advice
                            and should not be used to diagnose or treat any condition.
                            If you have any concerns about your mental health, we
                            strongly recommend that you speak with a healthcare
                            professional.
                            <br />
                            <br />
                            You can share this chart with people you
                            trust, but it's not intended to be used as a diagnostic tool.
                            <br />
                            Right click on the chart and select "Copy image" or "Save image as..."
                            to save the chart to your computer.
